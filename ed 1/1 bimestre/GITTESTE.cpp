...
int main(void)
{
    ...
    while (1)
    {
        ...
        case 'B':
        case 'b':
            printf("Digite a linha e coluna da carta que voce deseja mover.\n");
            scanf("%d %d", &i, &j);
            printf("Digite a coluna onde voce deseja colocar a carta.\n");
            scanf("%d", &j2);
        ...
        case 'D':
        case 'd':
            printf("Digite a coluna de onde voce deseja tirar a carta.\n");
            scanf("%d", &j);
            moveBaixoCima(j);
            break;
        case 'E':
        ...
        case 'F':
        case 'f':
            printf("Digite o naipe [c/e/o/p] e a coluna onde voce deseja inserir a carta.\n");
            scanf(" %c %d", &c, &j);
            moveCimaBaixo(c, j);
            break;
        default:
...
void criarMonte(void)
{
	...
	n = static_cast<noCarta*>(malloc(sizeof(noCarta)));
	...
	for(c1=0;c1<4;c1++)
	{
		for(c2=1;c2<=13;c2++)
		{
			...
			if(c1!=3 || c2!=13)
			{
				n->prox = static_cast<noCarta*>(malloc(sizeof(noCarta)));
				n=n->prox;
			}
			else
				n->prox=NULL;
